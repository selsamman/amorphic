...
function startUpServer(preSessionInject, postSessionInject, appList, appStartList, appDirectory, mainApp, sessionRouter) {
    ...
    app.use(initializePerformance)
        ...
        .use(downloadRouter.bind(this, sessions, hostName, controllers, nonObjTemplatelogLevel))

        .use(connect.bodyParser())

        .use(postRouter.bind(this, sessions, hostName, controllers, nonObjTemplatelogLevel))

        .use(amorphicEntry.bind(this, sessions, hostName, controllers, nonObjTemplatelogLevel));

    if (postSessionInject) {
        postSessionInject.call(null, app);
    }

    app.use(router.bind(this, hostName, sessions, nonObjTemplatelogLevel, controllers));
