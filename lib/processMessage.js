 ...
 */
function processMessage(req, resp, sessions, amorphicOptions, nonObjTemplatelogLevel, applicationConfig,
    ...
    establishServerSession(req, path, newPage, forceReset, message.rootId, applicationConfig, sessions,
        amorphicOptions, applicationSource, applicationSourceMap, applicationPersistorProps, hostName, controllers,
