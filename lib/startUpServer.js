 ...
 */
function startUpServer(preSessionInject, postSessionInject, appList, appStartList, appDirectory, mainApp, sessionRouter, amorphicOptions, downloads, applicationConfig, sessions, applicationSource, applicationSourceMap, applicationPersistorProps, hostName, controllers, nonObjTemplatelogLevel, sendToLog, appContext) {
    var app = connect();
    ...
    app.use(router.bind(this, hostName, applicationConfig, sendToLog, sessions, amorphicOptions, nonObjTemplatelogLevel, applicationSource, applicationSourceMap, applicationPersistorProps, controllers));
