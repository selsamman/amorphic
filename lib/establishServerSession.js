...
function establishServerSession(req, path, newPage, reset, newControllerId, applicationConfig, sessions, amorphicOptions, applicationSource, applicationSourceMap,
    ...
    return continuedServerSession(req, config, controllerPath, initObjectTemplate, path, time, appVersion, sessionExpiration,
 ...
 */
function continuedServerSession(req, config, controllerPath, initObjectTemplate, path, time, appVersion, sessionExpiration,
                                applicationPersistorProps, amorphicOptions, applicationSource, applicationSourceMap, session, sessionStore,
                                newControllerId, hostName, objectCacheExpiration, newPage, applicationConfig, controllers, nonObjTemplatelogLevel, sessions, sendToLog, reset) {
