...
function establishDaemon(path,
                         applicationConfig, amorphicOptions, applicationSource, applicationSourceMap,
    ...
    appTemplates = getTemplates(persistableTemplate, config.appPath, [prop + '.js'], config, path, null, null,
