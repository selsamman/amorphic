 ...
 */
function amorphicEntry(sessions, controllers, nonObjTemplatelogLevel, sendToLog, req, resp, next) {
    var amorphicOptions;
    ...
    if (req.originalUrl.match(/([A-Za-z0-9_]*)\.cached.js.map/)) {
        ...
        establishServerSession(req, appName, 'initial', false, null, sessions, controllers,
