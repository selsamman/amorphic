...
function getTemplate(file, options, uses) {
    return function getTemplateCurry(ignoringClient, requiredTemplates, filesNeeded, ref, appPath, appName,
                                     persistObjectTemplate, config, mixins, fileInitializers, filePaths,
                                     amorphicOptions, applicationSourceCandidate, currentContext, UsesV2ReturnPass1) {
        return _getTemplate(
            file,
            options,
            uses,
...
function _getTemplate(file, options, uses, ignoringClient, requiredTemplates, filesNeeded, ref, appPath, appName,
                      persistObjectTemplate, config, mixins, fileInitializers, filePaths, amorphicOptions,
