...
var intializePerformance = require('./util/intializePerformance').intializePerformance;
...
var controllers = {};
var downloads;
var generateDownloadsDir = require('./util/generateDownloadsDir').generateDownloadsDir;
var os = require('os');
