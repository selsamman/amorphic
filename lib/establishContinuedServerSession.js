 ...
 */
function establishContinuedServerSession(req, config, controllerPath, initObjectTemplate, path, time, appVersion,
                                         sessionExpiration, applicationPersistorProps, amorphicOptions,
                                         applicationSource, applicationSourceMap, session, sessionStore,
                                         newControllerId, hostName, objectCacheExpiration, newPage, applicationConfig,
    ...
    controller = getController(path, controllerPath, initObjectTemplate, session, objectCacheExpiration, sessionStore,
        newPage, shouldReset, newControllerId, req, applicationConfig, controllers, nonObjTemplatelogLevel,
