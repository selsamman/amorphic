 ...
 */
function establishApplication(appPath, path, cpath, initObjectTemplate, sessionExpiration, objectCacheExpiration, sessionStore, _loggerCall, appVersion, appConfig, logLevel,
