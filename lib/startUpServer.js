...
function startUpServer(preSessionInject, postSessionInject, appList, appStartList, appDirectory, sessionRouter) {
    ...
    app.use(uploadRouter.bind(this, downloads))
        .use(downloadRouter.bind(this, sessions, controllers))
        .use(postRouter.bind(this, sessions, controllers))
        .use(amorphicEntry.bind(this, sessions, controllers))
        .use(router.bind(this, sessions, controllers));
