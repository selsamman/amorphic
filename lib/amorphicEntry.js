...
var logMessage = require('./util/logger').logMessage;
...
var displayPerformance = require('./util/displayPerformance').displayPerformance;
 ...
 */
function amorphicEntry(sessions, hostName, controllers, nonObjTemplatelogLevel, sendToLog, req, resp, next) {
    var amorphicOptions;
    ...
    if (req.originalUrl.match(/([A-Za-z0-9_]*)\.cached.js.map/)) {
        ...
        establishServerSession(req, appName, 'initial', false, null, sessions, hostName, controllers,
