 ...
 */
function processContentRequest(request, response, sessions, hostName, controllers, nonObjTemplatelogLevel, sendToLog) {

    var path = url.parse(request.url, true).query.path;

    establishServerSession(request, path, false, false, null, sessions, hostName, controllers,
