...
function startUpServer(preSessionInject, postSessionInject, appList, appStartList, appDirectory, mainApp, sessionRouter,
    ...
    app.use(initializePerformance)
        ...
        .use(downloadRouter.bind(this, sessions, controllers, nonObjTemplatelogLevel, sendToLog))

        .use(connect.bodyParser())

        .use(postRouter.bind(this, sessions, controllers, nonObjTemplatelogLevel, sendToLog))

        .use(amorphicEntry.bind(this, sessions, controllers, nonObjTemplatelogLevel, sendToLog));

    if (postSessionInject) {
        postSessionInject.call(null, app);
    }

    app.use(router.bind(this, sendToLog, sessions, nonObjTemplatelogLevel, controllers));
